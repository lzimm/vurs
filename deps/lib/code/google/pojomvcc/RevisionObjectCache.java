 ...
 * All additions/modifications/removals for {@code code.google.pojomvcc.CacheElement}s are performed against an
...
public interface RevisionObjectCache<K,V> extends ReadOnlyRevisionObjectCache<K,V> {
  /**
   * Adds the provided {@code code.google.pojomvcc.CacheElement} with the provided {@code code.google.pojomvcc.CacheKey} to
   * this {@code code.google.pojomvcc.ObjectCache}.
   *
   * @param key
   * @param object
   */
  ...
  /**
   * Removes the {@code code.google.pojomvcc.CacheElement} currently registered with the provided {@code code.google.pojomvcc.CacheKey}
  ...
  /**
   * Returns a {@code List} of {@link K}s for all {@code code.google.pojomvcc.CacheElement}s that
  ...
  /**
   * Updates this {@link RevisionObjectCache} with the latest revision of the {@code code.google.pojomvcc.RootObjectCache}
   * automatically. The provided {@link RefreshOptions} dictates what should happen when
   * conflicts between this {@code code.google.pojomvcc.RevisionObjectCache} and the {@code code.google.pojomvcc.RootObjectCache}
   * occur.
   *
   * @param options
   */
  ...
  /**
   * Returns the {@code java.util.List} of {@link K} that are in this {@link code.google.pojomvcc.RevisionObjectCache}.
   *
