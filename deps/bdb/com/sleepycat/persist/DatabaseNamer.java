 ...
 * names are:</p>
 *
 * <pre>   bdb.com.sleepycat.persist.formats</pre>
 * <pre>   bdb.com.sleepycat.persist.sequences</pre>
 *
 * <p>With default database naming, databases with the following names will be
 * present each store.</p>
 *
 * <pre>   STORE_NAME-bdb.com.sleepycat.persist.formats</pre>
 * <pre>   STORE_NAME-bdb.com.sleepycat.persist.sequences</pre>
 *
