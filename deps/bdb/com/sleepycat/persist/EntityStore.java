...
import bdb.com.sleepycat.je.Database; // for javadoc
...
/* <!-- begin JE only --> */
import bdb.com.sleepycat.je.EnvironmentFailureException ; // for javadoc
import bdb.com.sleepycat.je.OperationFailureException ; // for javadoc
/* <!-- end JE only --> */
...
import bdb.com.sleepycat.persist.impl.Store;
import bdb.com.sleepycat.persist.model.DeleteAction;
import bdb.com.sleepycat.persist.model.Entity; // for javadoc
import bdb.com.sleepycat.persist.model.EntityModel;
import bdb.com.sleepycat.persist.model.PrimaryKey;
import bdb.com.sleepycat.persist.model.SecondaryKey;
 ...
 * with the {@link bdb.com.sleepycat.je Base API}.  Methods in the {@link
 ...
 * between {@link bdb.com.sleepycat.je.DatabaseEntry} objects and entity model
 * objects.</p>
 *
 ...
 * tools such as {@link bdb.com.sleepycat.je.util.DbDump} and {@link
 * bdb.com.sleepycat.je.util.DbLoad}.</p>
 *
 ...
 * <li>If you are using {@link bdb.com.sleepycat.je.util.DbDump} or {@link
 * bdb.com.sleepycat.je.util.DbLoad} to perform a backup or copy databases between
 ...
 * the store:</p>
 * <pre>   persist#STORE_NAME#bdb.com.sleepycat.persist.formats</pre>
 * <pre>   persist#STORE_NAME#bdb.com.sleepycat.persist.sequences</pre>
...
public class EntityStore {
     ...
     * {@link bdb.com.sleepycat.persist.evolve Class Evolution} for more
     * information.
     *
     * <!-- begin JE only -->
     ...
     * @throws DatabaseException the base class for all BDB exceptions.
     *
     * @see bdb.com.sleepycat.persist.evolve Class Evolution
     */
