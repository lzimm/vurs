...
import bdb.com.sleepycat.collections.StoredMap;
...
import bdb.com.sleepycat.je.DatabaseException; // for javadoc
...
/* <!-- end JE only --> */
import bdb.com.sleepycat.je.SecondaryDatabase; // for javadoc
 ...
 * part of the {@link bdb.com.sleepycat.je Base API}.  Transactions are created
 ...
 * bdb.com.sleepycat.je Base API}.  At this level, an index is a Btree managed by
...
public interface EntityIndex<K, V> {
     ...
     * {@link CursorConfig} and {@link bdb.com.sleepycat.je.TransactionConfig}.</p>
     * <!-- end JE only -->
     *
     * @param txn the transaction used to protect all operations performed with
     * the cursor, or null if the operations should not be transaction
     ...
     * bdb.com.sleepycat.collections Collections API}.  Stored collections conform
