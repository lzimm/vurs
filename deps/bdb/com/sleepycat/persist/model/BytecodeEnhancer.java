...
package bdb.com.sleepycat.persist.model;

import static bdb.com.sleepycat.asm.Opcodes.AALOAD;
import static bdb.com.sleepycat.asm.Opcodes.ACC_ABSTRACT;
import static bdb.com.sleepycat.asm.Opcodes.ACC_PRIVATE;
import static bdb.com.sleepycat.asm.Opcodes.ACC_PUBLIC;
import static bdb.com.sleepycat.asm.Opcodes.ACC_STATIC;
import static bdb.com.sleepycat.asm.Opcodes.ACC_TRANSIENT;
import static bdb.com.sleepycat.asm.Opcodes.ACONST_NULL;
import static bdb.com.sleepycat.asm.Opcodes.ALOAD;
import static bdb.com.sleepycat.asm.Opcodes.ANEWARRAY;
import static bdb.com.sleepycat.asm.Opcodes.ARETURN;
import static bdb.com.sleepycat.asm.Opcodes.BIPUSH;
import static bdb.com.sleepycat.asm.Opcodes.CHECKCAST;
import static bdb.com.sleepycat.asm.Opcodes.DCMPL;
import static bdb.com.sleepycat.asm.Opcodes.DCONST_0;
import static bdb.com.sleepycat.asm.Opcodes.DUP;
import static bdb.com.sleepycat.asm.Opcodes.FCMPL;
import static bdb.com.sleepycat.asm.Opcodes.FCONST_0;
import static bdb.com.sleepycat.asm.Opcodes.GETFIELD;
import static bdb.com.sleepycat.asm.Opcodes.GOTO;
import static bdb.com.sleepycat.asm.Opcodes.ICONST_0;
import static bdb.com.sleepycat.asm.Opcodes.ICONST_1;
import static bdb.com.sleepycat.asm.Opcodes.ICONST_2;
import static bdb.com.sleepycat.asm.Opcodes.ICONST_3;
import static bdb.com.sleepycat.asm.Opcodes.ICONST_4;
import static bdb.com.sleepycat.asm.Opcodes.ICONST_5;
import static bdb.com.sleepycat.asm.Opcodes.IFEQ;
import static bdb.com.sleepycat.asm.Opcodes.IFGT;
import static bdb.com.sleepycat.asm.Opcodes.IFLE;
import static bdb.com.sleepycat.asm.Opcodes.IFNE;
import static bdb.com.sleepycat.asm.Opcodes.IFNONNULL;
import static bdb.com.sleepycat.asm.Opcodes.IF_ICMPNE;
import static bdb.com.sleepycat.asm.Opcodes.ILOAD;
import static bdb.com.sleepycat.asm.Opcodes.INVOKEINTERFACE;
import static bdb.com.sleepycat.asm.Opcodes.INVOKESPECIAL;
import static bdb.com.sleepycat.asm.Opcodes.INVOKESTATIC;
import static bdb.com.sleepycat.asm.Opcodes.INVOKEVIRTUAL;
import static bdb.com.sleepycat.asm.Opcodes.IRETURN;
import static bdb.com.sleepycat.asm.Opcodes.ISUB;
import static bdb.com.sleepycat.asm.Opcodes.LCMP;
import static bdb.com.sleepycat.asm.Opcodes.LCONST_0;
import static bdb.com.sleepycat.asm.Opcodes.NEW;
import static bdb.com.sleepycat.asm.Opcodes.POP;
import static bdb.com.sleepycat.asm.Opcodes.PUTFIELD;
import static bdb.com.sleepycat.asm.Opcodes.RETURN;
...
import bdb.com.sleepycat.asm.AnnotationVisitor;
import bdb.com.sleepycat.asm.Attribute;
import bdb.com.sleepycat.asm.ClassAdapter;
import bdb.com.sleepycat.asm.ClassVisitor;
import bdb.com.sleepycat.asm.FieldVisitor;
import bdb.com.sleepycat.asm.Label;
import bdb.com.sleepycat.asm.MethodVisitor;
import bdb.com.sleepycat.asm.Type;
 ...
 * resulting enhanced class implements the bdb.com.sleepycat.persist.impl.Enhanced
 * interface.
 *
