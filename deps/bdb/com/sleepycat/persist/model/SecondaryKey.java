 ...
 * is accessed via a {@link bdb.com.sleepycat.persist.SecondaryIndex}.
 *
...
public @interface SecondaryKey {
     ...
     * entity.  If it does not, a {@link
     * bdb.com.sleepycat.je.ForeignConstraintException} will be thrown by the
     * {@link PrimaryIndex} {@code put} method.</p>
     *
     ...
     * {@link bdb.com.sleepycat.je.DeleteConstraintException} is thrown in order to
