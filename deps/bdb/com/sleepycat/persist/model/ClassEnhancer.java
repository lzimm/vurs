...
import bdb.com.sleepycat.asm.ClassReader;
import bdb.com.sleepycat.asm.ClassVisitor;
import bdb.com.sleepycat.asm.ClassWriter;
 ...
 * program}.  It may also be used via an {@link ClassEnhancerTask ant task}.
 * </p>
 *
...
public class ClassEnhancer implements ClassFileTransformer {
     ...
     * date.  For example:
     *
     * <pre class="code">java -cp je-&lt;version&gt;.jar bdb.com.sleepycat.persist.model.ClassEnhancer ./classes</pre>
     *
