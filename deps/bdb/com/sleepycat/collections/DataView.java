...
import bdb.com.sleepycat.je.JoinConfig;
...
import bdb.com.sleepycat.je.SecondaryKeyCreator;
...
final class DataView implements Cloneable {
    ...
    DataView(Database database, EntryBinding keyBinding,
        ...
        if (keyBinding instanceof bdb.com.sleepycat.bind.RecordNumberBinding) {
            if (!recNumAllowed) {
                throw new IllegalArgumentException
