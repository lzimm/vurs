...
import bdb.com.sleepycat.bind.RecordNumberBinding;
...
import bdb.com.sleepycat.util.keyrange.KeyRangeException;
...
public class StoredList<E> extends StoredCollection<E> implements List<E> {
     ...
     * If a {@link bdb.com.sleepycat.collections.PrimaryKeyAssigner} is associated
     ...
     * bdb.com.sleepycat.collections.PrimaryKeyAssigner} and is not a QUEUE or
     * RECNO database.
     *
     * @throws RuntimeExceptionWrapper if a checked exception is thrown,
     * including a {@code DatabaseException} on BDB (C Edition).
