...
package bdb.com.sleepycat.bind.tuple;
 ...
 * instance, which is also a {@link bdb.com.sleepycat.util.FastOutputStream}
...
public class TupleBase<E> {
     ...
     * bdb.com.sleepycat.util.FastOutputStream#DEFAULT_INIT_SIZE} size will be
     * used.</p>
     */
    public TupleBase() {
        outputBufferSize = 0;
     ...
     * bdb.com.sleepycat.util.FastOutputStream#DEFAULT_INIT_SIZE} size is used.</p>
     *
     ...
     * {@link bdb.com.sleepycat.util.FastOutputStream#reset} method before each
     * use.</p>
     *
