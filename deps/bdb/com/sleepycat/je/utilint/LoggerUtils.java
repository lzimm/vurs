 ...
 * bdb.com.sleepycat.je.rep.monitor.Monitor does not have an environment, but does
...
public class LoggerUtils {
    ...
    public static Logger getLogger(Class<?> cl) {
        ...
        if (handlers != null) {
            for (Handler h : handlers) {
                 ...
                 * to set bdb.com.sleepycat.je.util.ConsoleHandler in their logging
                 * properties file.
                 */
    ...
    public static Logger getLoggerFixedPrefix(Class<?> cl,
        ...
        if (!hasConsoleHandler(logger)) {
            logger.addHandler(new bdb.com.sleepycat.je.util.ConsoleHandler
