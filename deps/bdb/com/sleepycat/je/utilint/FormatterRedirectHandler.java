 ...
 * bdb.com.sleepycat.je.utilint.ConsoleRedirectHandler, but in this case, an
...
public class FormatterRedirectHandler 
     ...
     * bdb.com.sleepycat.je.util.ConsoleHandler. Check that handler's level and use
     * it to set FormatterRedirectHandler explicitly.
     */
    private static final String HANDLER_LEVEL = 
        bdb.com.sleepycat.je.util.ConsoleHandler.class.getName() + ".level";
