...
public class VerifyConfig implements Cloneable {
    ...
    /**
     * Configures {@link bdb.com.sleepycat.je.Environment#verify
     * Environment.verify} and {@link bdb.com.sleepycat.je.Database#verify
     ...
     * bdb.com.sleepycat.je.Environment#verify Environment.verify} and {@link
     * bdb.com.sleepycat.je.Database#verify Database.verify} to propagate
    ...
    /**
     * Returns true if the {@link bdb.com.sleepycat.je.Environment#verify
     * Environment.verify} and {@link bdb.com.sleepycat.je.Database#verify
     ...
     * application.</p>
     *
     * @return true if the {@link bdb.com.sleepycat.je.Environment#verify
     * Environment.verify} and {@link bdb.com.sleepycat.je.Database#verify
     * Database.verify} are configured to propagate exceptions found during
     * verification.
     */
     ...
     * bdb.com.sleepycat.je.Environment#verify Environment.verify} and {@link
     * bdb.com.sleepycat.je.Database#verify Database.verify} to perform fine
     ...
     * bdb.com.sleepycat.je.Environment#verify Environment.verify} and {@link
     * bdb.com.sleepycat.je.Database#verify Database.verify} to print basic
