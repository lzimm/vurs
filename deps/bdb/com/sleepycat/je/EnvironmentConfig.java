...
public class EnvironmentConfig extends EnvironmentMutableConfig {
     ...
     * <td>0</td>
     * <td>{@value
     * bdb.com.sleepycat.je.config.EnvironmentParams#LOG_MEM_SIZE_MIN}</td>
     * <td>-none-</td>
     * </tr>
     * </table></p>
     */
     ...
     * <td>No</td>
     * <td>{@value
     * bdb.com.sleepycat.je.config.EnvironmentParams#NUM_LOG_BUFFERS_DEFAULT}</td>
     * <td>2</td>
     * <td>-none-</td>
     * </tr>
     * </table></p>
     ...
     * bdb.com.sleepycat.je.util.FileHandler.level = {@literal <LEVEL>} through the
     ...
     * set "bdb.com.sleepycat.je.util.FileHandler.level" in the EnvironmentConfig
     * object.
     */
     ...
     * bdb.com.sleepycat.je.util.ConsoleHandler.level = {@literal <LEVEL>} through
     * the java.util.logging configuration file, or through the
     * java.util.logging.LogManager. To set the handler level programmatically,
     * set "bdb.com.sleepycat.je.util.ConsoleHandler.level" in the
     ...
     * set bdb.com.sleepycat.je.util.FileHandler.limit = {@literal <NUMBER>}
     ...
     * set bdb.com.sleepycat.je.util.FileHandler.count = {@literal <NUMBER>}
     * through the java.util.logging configuration file, or through the
     * java.util.logging.LogManager.
     */
    ...
    public static final String CONSOLE_LOGGING_LEVEL = 
        "bdb.com.sleepycat.je.util.ConsoleHandler.level";
    ...
    public static final String FILE_LOGGING_LEVEL = 
        "bdb.com.sleepycat.je.util.FileHandler.level";
     ...
     * bdb.com.sleepycat.je.txn.level = {@literal <LEVEL>} through the
     * java.util.logging configuration file, or through the
     * java.util.logging.LogManager.
     */
     ...
     * bdb.com.sleepycat.je.recovery.level = {@literal <LEVEL>} through the
     * java.util.logging configuration file, or through the
     * java.util.logging.LogManager.
     */
     ...
     * bdb.com.sleepycat.je.evictor.level = {@literal <LEVEL>} through the
     * java.util.logging configuration file, or through the
     * java.util.logging.LogManager.
     */
     ...
     * bdb.com.sleepycat.je.cleaner.level = {@literal <LEVEL>} through the
     * java.util.logging configuration file, or through the
     * java.util.logging.LogManager.
     */
