...
import bdb.com.sleepycat.je.utilint.PropUtil;
...
public class Transaction {
     ...
     *
     * @see bdb.com.sleepycat.je.rep.CommitPointConsistencyPolicy
     */
     ...
     *
     * @throws bdb.com.sleepycat.je.rep.InsufficientAcksException if the master in
     * a replicated environment did not receive enough replica acknowledgments,
     * although the commit succeeded locally.
     *
     * @throws bdb.com.sleepycat.je.rep.ReplicaWriteException if a write operation
     ...
     * the {@link bdb.com.sleepycat.je.Environment#beginTransaction
     * Environment.beginTransaction} method.  Any value specified to this
     * method overrides both of those settings.</p>
     *
     * <p>All cursors opened within the transaction must be closed before the
     ...
     * throw {@link bdb.com.sleepycat.je.TransactionTimeoutException
     ...
     * throw {@link bdb.com.sleepycat.je.LockTimeoutException
