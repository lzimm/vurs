...
import static bdb.com.sleepycat.je.dbi.DbiStatDefinition.MB_GROUP_DESC;
import static bdb.com.sleepycat.je.dbi.DbiStatDefinition.MB_GROUP_NAME;
...
import bdb.com.sleepycat.bind.tuple.TupleOutput;
...
public class MemoryBudget implements EnvConfigObserver {
    ...
    // 36
    private final static int MAPLN_OVERHEAD_32_15 = 856;
    private final static int MAPLN_OVERHEAD_32_16 = 872;
    private final static int MAPLN_OVERHEAD_64_15 = 1500;
    private final static int MAPLN_OVERHEAD_64_16 = 1536;
    private final static int MAPLN_OVERHEAD_OOPS = 976;
    private final static int MAPLN_OVERHEAD_DALVIK = 1016;
    ...
    private final static int BIN_FIXED_OVERHEAD_OOPS = 408;
    private final static int BIN_FIXED_OVERHEAD_DALVIK = 458;

    // 18
    private final static int DIN_FIXED_OVERHEAD_32 = 378; // 352 in 1.5
    private final static int DIN_FIXED_OVERHEAD_64_15 = 552;
    private final static int DIN_FIXED_OVERHEAD_64_16 = 592;
    private final static int DIN_FIXED_OVERHEAD_OOPS = 408;
    ...
    private final static int DBIN_FIXED_OVERHEAD_OOPS = 424;
    ...
    private final static int IN_FIXED_OVERHEAD_OOPS = 368;
    ...
    private final static int TXN_OVERHEAD_64 = 329;
