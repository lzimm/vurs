...
import static bdb.com.sleepycat.je.dbi.DbiStatDefinition.ENV_GROUP_DESC;
import static bdb.com.sleepycat.je.dbi.DbiStatDefinition.ENV_GROUP_NAME;
...
import bdb.com.sleepycat.je.CacheMode;
import bdb.com.sleepycat.je.CacheModeStrategy;
import bdb.com.sleepycat.je.CheckpointConfig;
...
import bdb.com.sleepycat.je.DbInternal;
import bdb.com.sleepycat.je.Environment;
import bdb.com.sleepycat.je.EnvironmentConfig;
import bdb.com.sleepycat.je.EnvironmentFailureException;
import bdb.com.sleepycat.je.EnvironmentLockedException;
import bdb.com.sleepycat.je.EnvironmentMutableConfig;
import bdb.com.sleepycat.je.EnvironmentNotFoundException;
import bdb.com.sleepycat.je.EnvironmentStats;
import bdb.com.sleepycat.je.ExceptionListener;
import bdb.com.sleepycat.je.LockStats;
import bdb.com.sleepycat.je.LogScanConfig;
import bdb.com.sleepycat.je.LogScanner;
import bdb.com.sleepycat.je.OperationFailureException;
import bdb.com.sleepycat.je.StatsConfig;
import bdb.com.sleepycat.je.Transaction;
import bdb.com.sleepycat.je.TransactionConfig;
import bdb.com.sleepycat.je.TransactionStats;
import bdb.com.sleepycat.je.VerifyConfig;
import bdb.com.sleepycat.je.TransactionStats.Active;
import bdb.com.sleepycat.je.cleaner.Cleaner;
import bdb.com.sleepycat.je.cleaner.LocalUtilizationTracker;
import bdb.com.sleepycat.je.cleaner.UtilizationProfile;
import bdb.com.sleepycat.je.cleaner.UtilizationTracker;
import bdb.com.sleepycat.je.config.EnvironmentParams;
import bdb.com.sleepycat.je.evictor.Evictor;
import bdb.com.sleepycat.je.evictor.PrivateEvictor;
import bdb.com.sleepycat.je.evictor.SharedEvictor;
import bdb.com.sleepycat.je.evictor.Evictor.EvictionSource;
import bdb.com.sleepycat.je.incomp.INCompressor;
import bdb.com.sleepycat.je.latch.Latch;
import bdb.com.sleepycat.je.latch.LatchSupport;
import bdb.com.sleepycat.je.latch.SharedLatch;
import bdb.com.sleepycat.je.log.FileManager;
import bdb.com.sleepycat.je.log.LNFileReader;
import bdb.com.sleepycat.je.log.LatchedLogManager;
import bdb.com.sleepycat.je.log.LogEntryHeader;
import bdb.com.sleepycat.je.log.LogEntryType;
import bdb.com.sleepycat.je.log.LogItem;
import bdb.com.sleepycat.je.log.LogManager;
import bdb.com.sleepycat.je.log.ReplicationContext;
import bdb.com.sleepycat.je.log.SyncedLogManager;
import bdb.com.sleepycat.je.log.Trace;
import bdb.com.sleepycat.je.log.entry.LogEntry;
import bdb.com.sleepycat.je.log.entry.SingleItemEntry;
import bdb.com.sleepycat.je.recovery.Checkpointer;
import bdb.com.sleepycat.je.recovery.RecoveryInfo;
import bdb.com.sleepycat.je.recovery.RecoveryManager;
import bdb.com.sleepycat.je.recovery.VLSNRecoveryProxy;
import bdb.com.sleepycat.je.tree.BIN;
import bdb.com.sleepycat.je.tree.BINReference;
import bdb.com.sleepycat.je.tree.IN;
import bdb.com.sleepycat.je.tree.Key;
import bdb.com.sleepycat.je.tree.LN;
import bdb.com.sleepycat.je.txn.LockType;
import bdb.com.sleepycat.je.txn.LockUpgrade;
import bdb.com.sleepycat.je.txn.Locker;
import bdb.com.sleepycat.je.txn.ThreadLocker;
import bdb.com.sleepycat.je.txn.Txn;
import bdb.com.sleepycat.je.txn.TxnManager;
import bdb.com.sleepycat.je.util.DbBackup;
import bdb.com.sleepycat.je.utilint.DbLsn;
import bdb.com.sleepycat.je.utilint.ExceptionListenerUser;
import bdb.com.sleepycat.je.utilint.LoggerUtils;
import bdb.com.sleepycat.je.utilint.LongStat;
import bdb.com.sleepycat.je.utilint.StatGroup;
import bdb.com.sleepycat.je.utilint.TestHook;
import bdb.com.sleepycat.je.utilint.TestHookExecute;
import bdb.com.sleepycat.je.utilint.TracerFormatter;
...
public class EnvironmentImpl implements EnvConfigObserver {
     ...
     * references to bdb.com.sleepycat.je.jmx.*.
     */
    ...
    protected EnvironmentImpl(File envHome,
        ...
        try {
            ...
            consoleHandler =
                new bdb.com.sleepycat.je.util.ConsoleHandler(formatter, this);
    ...
    protected String getMonitorClassName() {
        return "bdb.com.sleepycat.je.jmx.JEMonitor";
    }

    protected String getDiagnosticsClassName() {
        return "bdb.com.sleepycat.je.jmx.JEDiagnostics";
    }
    ...
    private MemoryHandler initMemoryHandler() {
        ...
        String memHandlerName =
            bdb.com.sleepycat.je.util.MemoryHandler.class.getName();
        ...
        return new bdb.com.sleepycat.je.util.MemoryHandler(memoryTarget,
                                                       memoryHandlerSize,
                                                       pushLevel,
                                                       formatter);
    }
    ...
    private FileHandler initFileHandler()
        ...
        String handlerName = bdb.com.sleepycat.je.util.FileHandler.class.getName();
        ...
        try {
            return new bdb.com.sleepycat.je.util.FileHandler(logFilePattern,
                                                         limit,
                                                         count,
                                                         formatter,
                                                         this);
     ...
     * For replicated environments only; only the overridden method should
     * ever be called.
     * @throws bdb.com.sleepycat.je.rep.LockPreemptedException from subclasses.
     */
     ...
     * For replicated environments only; only the overridden method should
     * ever be called.
     * @throws bdb.com.sleepycat.je.rep.DatabasePreemptedException from subclasses.
     */
    public OperationFailureException
     ...
     * For replicated environments only; only the overridden method should
     * ever be called.
     * @throws bdb.com.sleepycat.je.rep.LogOverwriteException from subclasses.
     */
