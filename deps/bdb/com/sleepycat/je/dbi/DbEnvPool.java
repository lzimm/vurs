...
public class DbEnvPool {
     ...
     */
     private EnvironmentImpl loadRepImpl(File envHome,
        ...
        final String repClassName = "bdb.com.sleepycat.je.rep.impl.RepImpl";
        final String envImplName = "bdb.com.sleepycat.je.dbi.EnvironmentImpl";
        final String repProxy = "bdb.com.sleepycat.je.dbi.RepConfigProxy";
        try {
