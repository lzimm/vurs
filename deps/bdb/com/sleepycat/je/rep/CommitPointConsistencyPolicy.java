 ...
 * bdb.com.sleepycat.je.Environment#beginTransaction(bdb.com.sleepycat.je.Transaction,
 * bdb.com.sleepycat.je.TransactionConfig) Environment.beginTransaction()}
 ...
 * {@link bdb.com.sleepycat.je.TransactionConfig#setConsistencyPolicy} or as an
 * replication node wide default through {@link
 * bdb.com.sleepycat.je.rep.ReplicationConfig#setConsistencyPolicy}
 *
 * @see bdb.com.sleepycat.je.CommitToken
...
public class CommitPointConsistencyPolicy implements ReplicaConsistencyPolicy {
     ...
     * bdb.com.sleepycat.je.Transaction, bdb.com.sleepycat.je.TransactionConfig)
