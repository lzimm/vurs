...
import static bdb.com.sleepycat.je.rep.impl.RepParams.NODE_HOST_PORT;
 ...
 * read/write standalone {@link bdb.com.sleepycat.je.Environment}. Only a minimum
 ...
 * help of a {@link bdb.com.sleepycat.je.rep.NetworkRestore}
 * </li>
 * </ol>
 * <p>
 * For example:
...
public class DbEnableReplication {
     ...
     * bdb.com.sleepycat.je.rep.util.EnvConvertTest.
    ...
    private static final String usageString =
        ...
        "bdb.com.sleepycat.je.rep.util.DbEnableReplication\n" + 
     ...
     * Usage:
     * <pre>
     * java -cp je.jar bdb.com.sleepycat.je.rep.util.DbEnableReplication
     *   -h &lt;dir&gt;                          # environment home directory
     *   -groupName &lt;group name&gt;           # replication group name
     *   -nodeName &lt;node name&gt;             # replicated node name
     *   -nodeHostPort &lt;host name:port number&gt; # host name or IP address
