...
import bdb.com.sleepycat.je.rep.stream.MatchpointSearchResults;
 ...
 * executing with a {@link Durability} policy that specifies a {@link
 * bdb.com.sleepycat.je.Durability.ReplicaAckPolicy ReplicaAckPolicy} of NONE.
 * <p>
 ...
 * bdb.com.sleepycat.je.util.DbTruncateLog}.
 */
...
public class RollbackProhibitedException extends RestartRequiredException {
    ...
    public String getMessage() {
        ...
        return
            ...
            matchpointVLSN + 
            " using the directions in bdb.com.sleepycat.je.util.DbTruncateLog.";
    }
