...
import static bdb.com.sleepycat.je.rep.stream.FeederTxnStatDefinition.ACK_WAIT_MS;
import static bdb.com.sleepycat.je.rep.stream.FeederTxnStatDefinition.TXNS_ACKED;
import static bdb.com.sleepycat.je.rep.stream.FeederTxnStatDefinition.TXNS_NOT_ACKED;
...
public class FeederTxns {
    ...
    /*
     * @see bdb.com.sleepycat.je.rep.stream.FeederSource#close()
     */
    public void close() {
