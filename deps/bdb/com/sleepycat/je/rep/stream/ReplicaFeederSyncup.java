...
import static bdb.com.sleepycat.je.utilint.VLSN.NULL_VLSN;
...
import bdb.com.sleepycat.je.rep.RollbackProhibitedException;
import bdb.com.sleepycat.je.rep.impl.RepImpl;
import bdb.com.sleepycat.je.rep.impl.RepParams;
import bdb.com.sleepycat.je.rep.impl.node.LocalCBVLSNTracker;
import bdb.com.sleepycat.je.rep.impl.node.RepNode;
import bdb.com.sleepycat.je.rep.impl.node.Replay;
import bdb.com.sleepycat.je.rep.stream.Protocol.AlternateMatchpoint;
import bdb.com.sleepycat.je.rep.stream.Protocol.Entry;
import bdb.com.sleepycat.je.rep.stream.Protocol.EntryNotFound;
import bdb.com.sleepycat.je.rep.stream.Protocol.RestoreResponse;
...
public class ReplicaFeederSyncup {
    ...
    /** 
     * This interface is used instead of bdb.com.sleepycat.je.utilint.TestHook
