...
import bdb.com.sleepycat.je.log.FileHandle;
import bdb.com.sleepycat.je.log.FileManager;
import bdb.com.sleepycat.je.log.LogBuffer;
...
import bdb.com.sleepycat.je.rep.vlsn.VLSNIndex.ForwardVLSNScanner;
import bdb.com.sleepycat.je.rep.vlsn.VLSNIndex.WaitTimeOutException;
...
public class FeederReader extends VLSNReader {
    ...
    static class SwitchWindow extends ReadWindow {
        ...
        protected boolean fillNext(boolean singleFile, int bytesNeeded)
            ...
            /*
             * Try to fill the window by asking for the next offset.
             */
