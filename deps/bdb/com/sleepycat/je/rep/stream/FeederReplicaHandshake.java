...
import bdb.com.sleepycat.je.rep.impl.RepGroupImpl.NodeConflictException;
import bdb.com.sleepycat.je.rep.impl.node.Feeder;
import bdb.com.sleepycat.je.rep.impl.node.NameIdPair;
import bdb.com.sleepycat.je.rep.impl.node.RepNode;
import bdb.com.sleepycat.je.rep.impl.node.Feeder.ExitException;
import bdb.com.sleepycat.je.rep.stream.Protocol.JEVersions;
import bdb.com.sleepycat.je.rep.stream.Protocol.JEVersionsReject;
import bdb.com.sleepycat.je.rep.stream.Protocol.NodeGroupInfo;
import bdb.com.sleepycat.je.rep.stream.Protocol.ReplicaJEVersions;
import bdb.com.sleepycat.je.rep.stream.Protocol.ReplicaProtocolVersion;
import bdb.com.sleepycat.je.rep.stream.Protocol.SNTPRequest;
...
public class FeederReplicaHandshake {
     ...
     * the replica.
     *
     * This check currently requires strict equality of log versions.
     */
