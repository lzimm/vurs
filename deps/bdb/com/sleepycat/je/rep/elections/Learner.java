...
import bdb.com.sleepycat.je.rep.elections.Protocol.MasterQueryResponse;
import bdb.com.sleepycat.je.rep.elections.Protocol.Result;
import bdb.com.sleepycat.je.rep.elections.Protocol.Value;
import bdb.com.sleepycat.je.rep.impl.RepImpl;
import bdb.com.sleepycat.je.rep.impl.TextProtocol.InvalidMessageException;
...
public class Learner extends ElectionAgentThread {
    ...
    private Learner(RepNode repNode,
        ...
        setName("Learner Thread " + nameIdPair.getName());
