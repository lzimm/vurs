...
import static bdb.com.sleepycat.je.rep.impl.RepParams.ELECTIONS_OPEN_TIMEOUT;
import static bdb.com.sleepycat.je.rep.impl.RepParams.ELECTIONS_READ_TIMEOUT;

import bdb.com.sleepycat.je.rep.elections.Proposer.Proposal;
import bdb.com.sleepycat.je.rep.elections.Proposer.ProposalParser;
import bdb.com.sleepycat.je.rep.impl.RepImpl;
import bdb.com.sleepycat.je.rep.impl.TextProtocol;
...
public class Protocol extends TextProtocol {
    ...
    public class MasterQuery extends RequestMessage {
        ...
        public String toString() {
            return getOp() + " " + messagePrefixNocheck + " " + wireFormat();
        }
    }
