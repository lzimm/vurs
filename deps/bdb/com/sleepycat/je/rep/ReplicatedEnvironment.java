...
import bdb.com.sleepycat.je.VersionMismatchException;
 ...
 * </pre>
 * </p>
 * {@literal See} {@link bdb.com.sleepycat.je.rep.util.ReplicationGroupAdmin
 ...
 * group, use {@link bdb.com.sleepycat.je.rep.util.DbEnableReplication} to do a one
 * time conversion of the directory.
 * <p>
 * All other database objects, such as {@link bdb.com.sleepycat.je.Database} or
 * {@link bdb.com.sleepycat.je.Cursor} (when using the Base API) or {@link
 * bdb.com.sleepycat.persist.EntityStore} or {@link
 * bdb.com.sleepycat.persist.PrimaryIndex} (when using the Direct Persistence
...
public class ReplicatedEnvironment extends Environment {
     ...
     * default {@link bdb.com.sleepycat.je.rep.QuorumPolicy#SIMPLE_MAJORITY} calls
     ...
     * bdb.com.sleepycat.je.rep.QuorumPolicy#ALL}, which will cause the elections
     ...
     *
     * @throws UnknownMasterException if the node could not determine a Master.
     *
     ...
     * time period specified by the <code>
     * je.rep.group.joinGroupTimeout property.</code>
     *
     * @throws EnvironmentLockedException when an environment cannot be opened
     * for write access because another process has the same environment open
     * for write access.  <strong>Warning:</strong> This exception should be
     ...
     * bdb.com.sleepycat.je.Database Database}, {@link bdb.com.sleepycat.je.Cursor
     * Cursor} and {@link bdb.com.sleepycat.je.Transaction Transaction} handles.
     * </p>
     */
    @Override
