...
import static bdb.com.sleepycat.je.rep.ReplicatedEnvironment.State.DETACHED;
import static bdb.com.sleepycat.je.rep.ReplicatedEnvironment.State.MASTER;
import static bdb.com.sleepycat.je.rep.ReplicatedEnvironment.State.REPLICA;
import static bdb.com.sleepycat.je.rep.ReplicatedEnvironment.State.UNKNOWN;
import static bdb.com.sleepycat.je.rep.impl.RepParams.DBTREE_CACHE_CLEAR_COUNT;
import static bdb.com.sleepycat.je.rep.impl.RepParams.ENV_CONSISTENCY_TIMEOUT;
import static bdb.com.sleepycat.je.rep.impl.RepParams.ENV_SETUP_TIMEOUT;
import static bdb.com.sleepycat.je.rep.impl.RepParams.HEARTBEAT_INTERVAL;
...
import bdb.com.sleepycat.je.rep.GroupShutdownException;
import bdb.com.sleepycat.je.rep.MasterStateException;
import bdb.com.sleepycat.je.rep.MemberNotFoundException;
import bdb.com.sleepycat.je.rep.NoConsistencyRequiredPolicy;
...
import bdb.com.sleepycat.je.rep.elections.Elections;
import bdb.com.sleepycat.je.rep.elections.TimebasedProposalGenerator;
import bdb.com.sleepycat.je.rep.elections.Proposer.Proposal;
import bdb.com.sleepycat.je.rep.impl.GroupService;
import bdb.com.sleepycat.je.rep.impl.NodeStateService;
import bdb.com.sleepycat.je.rep.impl.PointConsistencyPolicy;
...
import bdb.com.sleepycat.je.rep.impl.RepNodeImpl;
...
import bdb.com.sleepycat.je.rep.stream.MasterChangeListener;
import bdb.com.sleepycat.je.rep.stream.MasterStatus;
import bdb.com.sleepycat.je.rep.stream.MasterSuggestionGenerator;
import bdb.com.sleepycat.je.rep.util.ldiff.LDiffService;
import bdb.com.sleepycat.je.rep.utilint.RepUtils;
import bdb.com.sleepycat.je.rep.utilint.ServiceDispatcher;
import bdb.com.sleepycat.je.rep.utilint.RepUtils.ExceptionAwareCountDownLatch;
import bdb.com.sleepycat.je.rep.vlsn.VLSNIndex;
import bdb.com.sleepycat.je.utilint.LoggerUtils;
import bdb.com.sleepycat.je.utilint.StoppableThread;
...
public class RepNode extends StoppableThread {
    ...
    private bdb.com.sleepycat.je.rep.impl.networkRestore.FeederManager
        logFeederManager;
    ...
    private void utilityServicesStart() {
        ...
        logFeederManager =
            new bdb.com.sleepycat.je.rep.impl.networkRestore.FeederManager
