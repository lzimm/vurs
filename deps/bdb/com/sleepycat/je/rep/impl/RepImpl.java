...
import static bdb.com.sleepycat.je.rep.NoConsistencyRequiredPolicy.NO_CONSISTENCY;
import static bdb.com.sleepycat.je.rep.impl.RepParams.NODE_NAME;
import static bdb.com.sleepycat.je.rep.impl.RepParams.VLSN_MAX_DIST;
import static bdb.com.sleepycat.je.rep.impl.RepParams.VLSN_MAX_MAP;
import static bdb.com.sleepycat.je.rep.impl.RepParams.VLSN_STRIDE;
...
import bdb.com.sleepycat.je.Durability;
...
import bdb.com.sleepycat.je.Durability.ReplicaAckPolicy;
import bdb.com.sleepycat.je.Durability.SyncPolicy;
...
import bdb.com.sleepycat.je.dbi.RepConfigProxy;
...
import bdb.com.sleepycat.je.rep.DatabasePreemptedException;
import bdb.com.sleepycat.je.rep.InsufficientAcksException;
import bdb.com.sleepycat.je.rep.InsufficientReplicasException;
import bdb.com.sleepycat.je.rep.LockPreemptedException;
import bdb.com.sleepycat.je.rep.LogOverwriteException;
import bdb.com.sleepycat.je.rep.QuorumPolicy;
import bdb.com.sleepycat.je.rep.RepInternal;
import bdb.com.sleepycat.je.rep.ReplicaConsistencyException;
import bdb.com.sleepycat.je.rep.ReplicaWriteException;
import bdb.com.sleepycat.je.rep.ReplicatedEnvironment;
import bdb.com.sleepycat.je.rep.ReplicatedEnvironmentStats;
import bdb.com.sleepycat.je.rep.ReplicationConfig;
import bdb.com.sleepycat.je.rep.ReplicationMutableConfig;
import bdb.com.sleepycat.je.rep.RestartRequiredException;
import bdb.com.sleepycat.je.rep.RollbackException;
import bdb.com.sleepycat.je.rep.StateChangeEvent;
import bdb.com.sleepycat.je.rep.StateChangeListener;
import bdb.com.sleepycat.je.rep.UnknownMasterException;
import bdb.com.sleepycat.je.rep.impl.node.NameIdPair;
import bdb.com.sleepycat.je.rep.impl.node.NodeState;
import bdb.com.sleepycat.je.rep.impl.node.RepNode;
import bdb.com.sleepycat.je.rep.impl.node.Replay;
import bdb.com.sleepycat.je.rep.stream.FeederTxns;
import bdb.com.sleepycat.je.rep.txn.MasterThreadLocker;
import bdb.com.sleepycat.je.rep.txn.MasterTxn;
import bdb.com.sleepycat.je.rep.txn.ReadonlyTxn;
import bdb.com.sleepycat.je.rep.txn.ReplayTxn;
import bdb.com.sleepycat.je.rep.txn.ReplicaThreadLocker;
import bdb.com.sleepycat.je.rep.utilint.HostPortPair;
import bdb.com.sleepycat.je.rep.utilint.RepUtils;
import bdb.com.sleepycat.je.rep.utilint.ReplicationFormatter;
import bdb.com.sleepycat.je.rep.vlsn.VLSNIndex;
import bdb.com.sleepycat.je.rep.vlsn.VLSNRecoveryTracker;
...
import bdb.com.sleepycat.je.utilint.BooleanStat;
import bdb.com.sleepycat.je.utilint.LoggerUtils;
import bdb.com.sleepycat.je.utilint.StatGroup;
import bdb.com.sleepycat.je.utilint.StringStat;
...
public class RepImpl
    ...
    public String getMonitorClassName() {
        return "bdb.com.sleepycat.je.rep.jmx.RepJEMonitor";
    }

    @Override
    public String getDiagnosticsClassName() {
        return "bdb.com.sleepycat.je.rep.jmx.RepJEDiagnostics";
    }
        ...
        if (!dbTreeReplicatedBit) {
            ...
            throw new UnsupportedOperationException
                ("This environment must be converted for replication." +
                 " using bdb.com.sleepycat.je.rep.util.DbEnableReplication.");
        }
    }
