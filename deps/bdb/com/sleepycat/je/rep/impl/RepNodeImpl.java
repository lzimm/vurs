...
public class RepNodeImpl implements ReplicationNode {
    ...
    /* (non-Javadoc)
     * @see bdb.com.sleepycat.je.rep.ReplicationNode#getSocketAddress()
     */
    ...
    /* (non-Javadoc)
     * @see bdb.com.sleepycat.je.rep.ReplicationNode#getName()
     */
    ...
    /* (non-Javadoc)
     * @see bdb.com.sleepycat.je.rep.ReplicationNode#getNodeType()
     */
    ...
    /* (non-Javadoc)
     * @see bdb.com.sleepycat.je.rep.ReplicationNode#getHostName()
     */
    ...
    /* (non-Javadoc)
     * @see bdb.com.sleepycat.je.rep.ReplicationNode#getPort()
     */
    public int getPort() {
        return port;
    }
    ...
    /* (non-Javadoc)
     * @see bdb.com.sleepycat.je.rep.ReplicationNode#getHostPortPair()
     */
