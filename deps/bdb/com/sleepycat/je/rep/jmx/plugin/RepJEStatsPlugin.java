...
package bdb.com.sleepycat.je.rep.jmx.plugin;
...
import bdb.com.sleepycat.je.jmx.plugin.JEStats;
import bdb.com.sleepycat.je.jmx.plugin.Stats;
import bdb.com.sleepycat.je.jmx.plugin.StatsPlugin;

public class RepJEStatsPlugin extends StatsPlugin {
    public static final String mBeanNamePrefix = 
        "bdb.com.sleepycat.je.jmx:name=RepJEMonitor(*";
