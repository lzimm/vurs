 ...
 * on a replica node:
 * {@link bdb.com.sleepycat.je.Environment#truncateDatabase truncateDatabase},
 * {@link bdb.com.sleepycat.je.Environment#removeDatabase removeDatabase} and
 * {@link bdb.com.sleepycat.je.Environment#renameDatabase renameDatabase}.</p>
 *
 * <p>When using the {@link bdb.com.sleepycat.persist DPL}, this occurs only in two
 * circumstances:</p>
 * <ol>
 * <li>This exception is thrown on a Replica node when the {@link
 * bdb.com.sleepycat.persist.EntityStore#truncateClass truncateClass} method has
 ...
 *
 * <p>The {@link bdb.com.sleepycat.je.Transaction} handle is <em>not</em>
