 ...
 * bdb.com.sleepycat.collections persistent collections} with {@link
 * bdb.com.sleepycat.collections.CurrentTransaction} or {@link 
 * bdb.com.sleepycat.collections.TransactionRunner}, or when using XA transactions 
 ...
 * Cursor#getNext Cursor.getNext}, {@link bdb.com.sleepycat.persist.EntityIndex#get
 * EntityIndex.get}, {@link bdb.com.sleepycat.persist.EntityCursor#next
 * EntityCursor.next} and {@link bdb.com.sleepycat.collections.StoredMap#get
 ...
 *
 *     <ul>
 *     <li>{@link bdb.com.sleepycat.je.rep.LockPreemptedException} is a subclass
 ...
 *   
 *   <li>{@link bdb.com.sleepycat.je.rep.DatabasePreemptedException} is thrown in a
 ...
 * bdb.com.sleepycat.persist.PrimaryIndex#put PrimaryIndex.put}, {@link
 * bdb.com.sleepycat.persist.EntityCursor#delete EntityCursor.delete} and {@link
 * bdb.com.sleepycat.collections.StoredMap#put StoredMap.put}.  These methods may
 ...
 *   truncated, removed or renamed the database.</li>
 *
 *   <li>{@link bdb.com.sleepycat.je.rep.ReplicaWriteException} is always thrown in
