...
package bdb.com.sleepycat.je.log;
...
import bdb.com.sleepycat.je.LogWriteException;
import bdb.com.sleepycat.je.StatsConfig;
import bdb.com.sleepycat.je.ThreadInterruptedException;
   ...
   /**
    ...
    public static void removeFiles(File envFile) {
        ...
        for (int i = 0; i < targetFiles.length; i++) {
            ...
            if (!done) {
                System.out.println
                    ("Warning, couldn't delete " + targetFiles[i] +
    ...
    void readFromFile(RandomAccessFile file,
        ...
        try {
            ...
            /*
             * Check if there's a pending write(s) for this fileNo/offset and
             * if so, use it to fulfill this read request.
             */
            if (useWriteQueue &&
    ...
    private static class FileCache {
        ...
        private List<Long> fileList;    // list of file numbers
