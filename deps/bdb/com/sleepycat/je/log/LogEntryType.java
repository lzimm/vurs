...
import bdb.com.sleepycat.je.log.entry.BINDeltaLogEntry;
import bdb.com.sleepycat.je.log.entry.DeletedDupLNLogEntry;
import bdb.com.sleepycat.je.log.entry.FileHeaderEntry;
import bdb.com.sleepycat.je.log.entry.INLogEntry;
...
public class LogEntryType {
    ...
    public static final LogEntryType LOG_LN_TRANSACTIONAL =
        new LogEntryType
        ((byte) 1, "LN_TX",
         new LNLogEntry(bdb.com.sleepycat.je.tree.LN.class),
         Txnal.TXNAL,
    ...
    public static final LogEntryType LOG_MAPLN_TRANSACTIONAL =
        new LogEntryType
        ((byte) 3, "MapLN_TX",
         new LNLogEntry(bdb.com.sleepycat.je.tree.MapLN.class),
         Txnal.TXNAL,
    ...
    public static final LogEntryType LOG_DUPCOUNTLN_TRANSACTIONAL =
        ...
        ((byte) 9, "DupCountLN_TX",
         new LNLogEntry(bdb.com.sleepycat.je.tree.DupCountLN.class),
         Txnal.TXNAL,
         Marshall.OUTSIDE_LATCH,
         Replicable.LOCAL);
    ...
    public static final LogEntryType LOG_FILESUMMARYLN =
        ...
        ((byte) 11, "FileSummaryLN",
         new LNLogEntry(bdb.com.sleepycat.je.tree.FileSummaryLN.class),
         Txnal.NON_TXNAL,
         Marshall.INSIDE_LATCH,
         Replicable.LOCAL);
    ...
    public static final LogEntryType LOG_IN =
        new LogEntryType
        ((byte) 12, "IN",
         new INLogEntry(bdb.com.sleepycat.je.tree.IN.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         Replicable.LOCAL);
    ...
    public static final LogEntryType LOG_BIN =
        new LogEntryType
        ((byte) 13, "BIN",
         new INLogEntry(bdb.com.sleepycat.je.tree.BIN.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         Replicable.LOCAL);
    ...
    public static final LogEntryType LOG_DIN =
        new LogEntryType
        ((byte) 14, "DIN",
         new INLogEntry(bdb.com.sleepycat.je.tree.DIN.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         Replicable.LOCAL);
    ...
    public static final LogEntryType LOG_DBIN =
        new LogEntryType
        ((byte) 15, "DBIN",
         new INLogEntry(bdb.com.sleepycat.je.tree.DBIN.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         Replicable.LOCAL);
    ...
    public static final LogEntryType LOG_ROOT =
        ...
        ((byte) 16, "Root",
         new SingleItemEntry
         (bdb.com.sleepycat.je.dbi.DbTree.class),
         Txnal.NON_TXNAL,
         Marshall.INSIDE_LATCH,
         Replicable.LOCAL);
    ...
    public static final LogEntryType LOG_TXN_COMMIT =
        ...
        ((byte) 17, "Commit",
         new SingleItemEntry
         (bdb.com.sleepycat.je.txn.TxnCommit.class),
         Txnal.TXNAL,
         Marshall.OUTSIDE_LATCH,
    ...
    public static final LogEntryType LOG_TXN_ABORT =
        ...
        ((byte) 18, "Abort",
         new SingleItemEntry
         (bdb.com.sleepycat.je.txn.TxnAbort.class),
         Txnal.TXNAL,
         Marshall.OUTSIDE_LATCH,
         Replicable.REPLICABLE_MATCH);
    ...
    public static final LogEntryType LOG_CKPT_START =
        ...
        ((byte) 19, "CkptStart",
         new SingleItemEntry
         (bdb.com.sleepycat.je.recovery.CheckpointStart.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         Replicable.LOCAL);
    ...
    public static final LogEntryType LOG_CKPT_END =
        ...
        ((byte) 20, "CkptEnd",
         new SingleItemEntry
         (bdb.com.sleepycat.je.recovery.CheckpointEnd.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         Replicable.LOCAL);
    ...
    public static final LogEntryType LOG_IN_DELETE_INFO =
        ...
        ((byte) 21, "INDelete",
         new SingleItemEntry
         (bdb.com.sleepycat.je.tree.INDeleteInfo.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         Replicable.LOCAL);
    ...
    public static final LogEntryType LOG_BIN_DELTA =
        ...
        ((byte) 22, "BINDelta",
         ...
         (bdb.com.sleepycat.je.tree.BINDelta.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         Replicable.LOCAL);
    ...
    public static final LogEntryType LOG_TRACE =
        ...
        ((byte) 24, "Trace",
         new SingleItemEntry
         (bdb.com.sleepycat.je.log.Trace.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         Replicable.REPLICABLE_NO_MATCH);
    ...
    public static final LogEntryType LOG_FILE_HEADER =
        ...
        ((byte) 25, "FileHeader",
         new FileHeaderEntry
         (bdb.com.sleepycat.je.log.FileHeader.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         Replicable.LOCAL);
    ...
    public static final LogEntryType LOG_IN_DUPDELETE_INFO =
        ...
        ((byte) 26, "INDupDelete",
         new SingleItemEntry
         (bdb.com.sleepycat.je.tree.INDupDeleteInfo.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         Replicable.LOCAL);
    ...
    public static final LogEntryType LOG_TXN_PREPARE =
        ...
        ((byte) 27, "Prepare",
         new SingleItemEntry
         (bdb.com.sleepycat.je.txn.TxnPrepare.class),
         Txnal.TXNAL,
         Marshall.OUTSIDE_LATCH,
         Replicable.LOCAL);
    ...
    public static final LogEntryType LOG_ROLLBACK_START =
        ...
        ((byte) 28, "RollbackStart",
         new SingleItemEntry
         (bdb.com.sleepycat.je.txn.RollbackStart.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         Replicable.LOCAL);
    ...
    public static final LogEntryType LOG_ROLLBACK_END =
        ...
        ((byte) 29, "RollbackEnd",
         new SingleItemEntry
         (bdb.com.sleepycat.je.txn.RollbackEnd.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         Replicable.LOCAL);
    ...
    public static final LogEntryType LOG_MATCHPOINT =
        ...
        ((byte) 30, "Matchpoint",
         new SingleItemEntry
         (bdb.com.sleepycat.je.utilint.Matchpoint.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         Replicable.REPLICABLE_MATCH);
