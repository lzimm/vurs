...
public class SequenceConfig implements Cloneable {
    ...
    /**
     * Configures the {@link bdb.com.sleepycat.je.Database#openSequence
     ...
     * bdb.com.sleepycat.je.Database#openSequence Database.openSequence} method to
    ...
    /**
     * Returns true if the {@link bdb.com.sleepycat.je.Database#openSequence
     ...
     * application.</p>
     *
     * @return true if the {@link bdb.com.sleepycat.je.Database#openSequence
     * Database.openSequence} method is configured to create the sequence if it
     * does not already exist.
     */
