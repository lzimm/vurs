...
import bdb.com.sleepycat.je.dbi.DbEnvPool;
 ...
 * bdb.com.sleepycat.je.Database Database} or {@link bdb.com.sleepycat.je.Transaction
 * Transaction}.  Once {@link bdb.com.sleepycat.je.Environment#close
...
public class Environment {
     ...
     * Specifically, this includes {@link bdb.com.sleepycat.je.Database Database},
     * {@link bdb.com.sleepycat.je.Cursor Cursor} and {@link
     * bdb.com.sleepycat.je.Transaction Transaction} handles.</p>
     *
     ...
     *
     * @throws bdb.com.sleepycat.je.rep.InsufficientReplicasException if the Master
     * in a replicated environment could not contact a quorum of replicas as
     * determined by the {@link ReplicaAckPolicy}.
     *
     * @throws bdb.com.sleepycat.je.rep.ReplicaConsistencyException if a replica
