...
package bdb.com.sleepycat.je.cleaner;

import static bdb.com.sleepycat.je.cleaner.CleanerStatDefinition.GROUP_NAME;
import static bdb.com.sleepycat.je.cleaner.CleanerStatDefinition.GROUP_DESC;
...
import bdb.com.sleepycat.je.cleaner.FileSelector.CheckpointStartCleanerState;
import bdb.com.sleepycat.je.config.EnvironmentParams;
import bdb.com.sleepycat.je.dbi.DatabaseId;
import bdb.com.sleepycat.je.dbi.DatabaseImpl;
import bdb.com.sleepycat.je.dbi.DbConfigManager;
import bdb.com.sleepycat.je.dbi.DbTree;
import bdb.com.sleepycat.je.dbi.EnvConfigObserver;
...
import bdb.com.sleepycat.je.tree.TreeLocation;
import bdb.com.sleepycat.je.txn.BasicLocker;
import bdb.com.sleepycat.je.txn.LockGrantType;
import bdb.com.sleepycat.je.txn.LockResult;
import bdb.com.sleepycat.je.txn.LockType;
import bdb.com.sleepycat.je.utilint.DaemonRunner;
...
public class Cleaner implements DaemonRunner,
     ...
     * bdb.com.sleepycat.je.util.DbBackup} utility and is provided here as a
    ...
    private void processPendingLN(LN ln,
        ...
        try {
            ...
            LoggerUtils.traceAndLogException
                (env, "bdb.com.sleepycat.je.cleaner.Cleaner",
