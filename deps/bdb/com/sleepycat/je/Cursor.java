...
import bdb.com.sleepycat.je.dbi.CursorImpl.KeyChangeStatus;
...
import bdb.com.sleepycat.je.txn.BuddyLocker;
...
public class Cursor {
     ...
     * will fail.</p>
     *
     * @return {@link bdb.com.sleepycat.je.OperationStatus#KEYEMPTY
     * OperationStatus.KEYEMPTY} if the key/pair at the cursor position has
     * been deleted; otherwise, {@link
     * bdb.com.sleepycat.je.OperationStatus#SUCCESS OperationStatus.SUCCESS}.
     *
     * @throws OperationFailureException if one of the <a
     ...
     * bdb.com.sleepycat.je.OperationStatus#KEYEXIST OperationStatus.KEYEXIST} is
     * returned.</p>
     *
