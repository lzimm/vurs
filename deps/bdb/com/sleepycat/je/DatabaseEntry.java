 ...
 *
 * <p>Storage and retrieval for the {@link bdb.com.sleepycat.je.Database Database}
 * and {@link bdb.com.sleepycat.je.Cursor Cursor} methods are based on key/data
 ...
 * {@link bdb.com.sleepycat.je.Database Database} or {@link bdb.com.sleepycat.je.Cursor
 * Cursor} methods, the results are undefined.</p>
 *
 * <p>DatabaseEntry objects may be used in conjunction with the object mapping
 * support provided in the {@link bdb.com.sleepycat.bind} package.</p>
 *
...
public class DatabaseEntry {
     ...
     * bdb.com.sleepycat.je.Database#put Database.put} method in a database that
