...
import bdb.com.sleepycat.je.dbi.GetMode;
...
import bdb.com.sleepycat.je.utilint.DatabaseUtil;
 ...
 * bdb.com.sleepycat.je.DatabaseConfig DatabaseConfig} class. Database handles are
...
public class Database {
     ...
     * bdb.com.sleepycat.je.Cursor Cursor} and {@link bdb.com.sleepycat.je.Transaction
     * Transaction} handles.
     * <p>
     * When multiple threads are using the {@link bdb.com.sleepycat.je.Database
     ...
     * @see DatabaseConfig#setDeferredWrite DatabaseConfig.setDeferredWrite
     *
     * @throws bdb.com.sleepycat.je.rep.DatabasePreemptedException in a replicated
     ...
     * non-transactional database, null must be specified.
     *
     * @param key The key {@link bdb.com.sleepycat.je.DatabaseEntry
     ...
     * non-transactional database, null must be specified.
     *
     * @param key the key {@link bdb.com.sleepycat.je.DatabaseEntry DatabaseEntry}
     * operated on.
     *
     * @return The method will return {@link
     * bdb.com.sleepycat.je.OperationStatus#NOTFOUND OperationStatus.NOTFOUND} if
     * the specified key is not found in the database; otherwise the method
     * will return {@link bdb.com.sleepycat.je.OperationStatus#SUCCESS
    ...
    */
     ...
     * used.
     *
     * @return {@link bdb.com.sleepycat.je.OperationStatus#NOTFOUND
     * OperationStatus.NOTFOUND} if no matching key/data pair is found;
     * otherwise, {@link bdb.com.sleepycat.je.OperationStatus#SUCCESS
     * OperationStatus.SUCCESS}.
     *
     * @throws OperationFailureException if one of the <a
     ...
     * operated on.
     *
     * @param data the data {@link bdb.com.sleepycat.je.DatabaseEntry
     * DatabaseEntry} stored.
     *
     * @return {@link bdb.com.sleepycat.je.OperationStatus#SUCCESS
     ...
     * bdb.com.sleepycat.je.OperationStatus#KEYEXIST OpeationStatus.KEYEXIST} if
     ...
     * DatabaseEntry} stored.
     *
     * @return {@link bdb.com.sleepycat.je.OperationStatus#KEYEXIST
     * OperationStatus.KEYEXIST} if the key already appears in the database,
     * else {@link bdb.com.sleepycat.je.OperationStatus#SUCCESS
     * OperationStatus.SUCCESS}
     *
     * @throws OperationFailureException if one of the <a
     * href="../je/OperationFailureException.html#writeFailures">Write
     ...
     * database, else {@link bdb.com.sleepycat.je.OperationStatus#SUCCESS
     * OperationStatus.SUCCESS}
     *
     * @throws OperationFailureException if one of the <a
     * href="../je/OperationFailureException.html#writeFailures">Write
     ...
     * (using the {@link bdb.com.sleepycat.je.StatsConfig#setFast
    ...
    /**
     * Returns the {@link bdb.com.sleepycat.je.Environment Environment} handle for
     * the database environment underlying the {@link
     * bdb.com.sleepycat.je.Database Database}.
     *
     * <p>This method may be called at any time during the life of the
     * application.</p>
     *
     * @return The {@link bdb.com.sleepycat.je.Environment Environment} handle
    ...
    /**
     * Returns a list of all {@link bdb.com.sleepycat.je.SecondaryDatabase
     ...
     *
     * @return A list of all {@link bdb.com.sleepycat.je.SecondaryDatabase
     * SecondaryDatabase} objects associated with a primary database.
     */
