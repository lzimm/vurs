...
public class DatabaseConfig implements Cloneable {
    ...
    /**
     * Configures the {@link bdb.com.sleepycat.je.Environment#openDatabase
     * Environment.openDatabase} method to create the database if it does not
     * already exist.
     *
     * @param allowCreate If true, configure the {@link
     * bdb.com.sleepycat.je.Environment#openDatabase Environment.openDatabase}
    ...
    /**
     * Returns true if the {@link bdb.com.sleepycat.je.Environment#openDatabase
     ...
     * application.</p>
     *
     * @return true if the {@link bdb.com.sleepycat.je.Environment#openDatabase
     * Environment.openDatabase} method is configured to create the database
     * if it does not already exist.
     */
    ...
    /**
     * Configure the {@link bdb.com.sleepycat.je.Environment#openDatabase
