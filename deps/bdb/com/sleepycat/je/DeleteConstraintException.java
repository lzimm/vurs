 ...
 *
 * <p>When using the base API ({@code bdb.com.sleepycat.je}), this can occur when a
 ...
 *
 * <p>When using the DPL ({@code bdb.com.sleepycat.persist}), this can occur when a
 * {@link bdb.com.sleepycat.persist.model.SecondaryKey} is defined with a {@link
 * bdb.com.sleepycat.persist.model.SecondaryKey#relatedEntity}, and {@link
 * bdb.com.sleepycat.persist.model.SecondaryKey#onRelatedEntityDelete} is {@link
 * bdb.com.sleepycat.persist.model.DeleteAction#ABORT} (which is the default).</p>
 *
