...
public class PhraseInterpolation implements CassandraOpenSuperColumn<String, StringIndex, TimeUUID, TimeUUIDIndex, List<Entity<PingInterpolation>>> {
	...
	public static PrimaryKey<String, PrimaryString> interpolation;
